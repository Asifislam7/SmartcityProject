...
export default function BasicButtons() {
  return (
  <>
    <div className='container-lg w-100 p-5' style={{color:'darkgrey',background:'white'}}>
      <div className={styles.wastebuttons}>
      <Link href="/Wastemanage"><Button variant="contained" style={{width:'200px',fontSize:'20px'}}>Waste Management</Button></Link>
      <Link href="/Contractor"><Button variant="contained" style={{width:'200px',fontSize:'20px'}}>Contractor Section</Button></Link>
      </div>
